...
/**
 * POST /api/create-faculty-account
 *
 * Creates a Firebase Auth account for a faculty member using the Firebase REST API.
 * Runs server-side so it doesn't affect the admin's signed-in session.
 *
...
export async function POST(req: NextRequest) {
    try {
        ...
        console.error("create-faculty-account error:", err);
        return NextResponse.json(
