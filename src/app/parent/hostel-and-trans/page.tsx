      ...
      {services ? (
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="font-semibold text-gray-900 text-lg">
                              {services.hostel.block}, Room{" "}
                              {services.hostel.roomNumber}
                            </p>
                          </div>
                          <div>
                            <p className="text-gray-500 text-xs uppercase tracking-wide">
                      ...
                      <div>
                        ...
                        <div className="mb-4">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span
                              className={`px-2 py-1 text-xs font-bold rounded ${services.hostel.feeStatus === "Paid" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                            >
                          ...
                          <p className="text-3xl font-bold text-gray-900">
                            ₹
                            {services.hostel.feeStatus === "Paid"
                              ? "0"
                              : services.hostel.amountDue.toLocaleString()}
                          </p>
                        </div>
                        <p className="text-sm text-gray-500">
                          Due Date:{" "}
                          {new Date(
                            services.hostel.dueDate,
                          ).toLocaleDateString()}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="font-medium text-gray-900">
                            {services.transport.pickupPoint}
                          </p>
                          <p className="text-sm text-gray-600">
                            {services.transport.pickupTime}
                          </p>
                        </div>
                        <div>
                          <p className="text-gray-500 text-xs uppercase tracking-wide">
                          ...
                          <p className="font-medium text-gray-900">
                            {services.transport.driverName} (
                            {services.transport.driverContact})
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mb-4">
                        <div className="flex justify-between items-center mb-1">
                          <p className="text-gray-500 text-sm">Amount Due</p>
                          <span
                            className={`px-2 py-1 text-xs font-bold rounded ${services.transport.feeStatus === "Paid" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                          >
                        ...
                        <p className="text-3xl font-bold text-gray-900">
                          ₹
                          {services.transport.feeStatus === "Paid"
                            ? "0"
                            : services.transport.amountDue.toLocaleString()}
                        </p>
                      </div>
                      <p className="text-sm text-gray-500">
                        Due Date:{" "}
                        {new Date(
                          services.transport.dueDate,
                        ).toLocaleDateString()}
                      </p>
                    </div>
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-gray-500 mt-2">
            You haven't subscribed to hostel or transport services yet.
          </p>
        </div>
      )}
    </div>
